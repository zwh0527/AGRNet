...
net_arg.add_argument(
    "--embed_nums", type=int, default=3, help=""
    "number of embedding PointCN. Default: 3")
net_arg.add_argument(
    "--point_transformer_nums", type=int, default=5, help=""
    "number of point transformers. Default: 5")
net_arg.add_argument(
    "--corr_transformer_nums", type=int, default=13, help=""
    "number of corr transformers. Default: 13")
net_arg.add_argument(
    "--transformer_heads", type=int, default=4, help=""
    "number of transformer heads. Default: 4")
net_arg.add_argument(
    "--iter_nums", type=int, default=2, help=""
...
net_arg.add_argument(
    "--is_final_predictor", type=str2bool, default=True, help=""
    "whether nor not to use final predictor")
net_arg.add_argument(
...
data_arg.add_argument(
    "--data_va", type=str, default='../data_dump/yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    ...
    "run_mode")
train_arg.add_argument(
    "--train_lr", type=float, default=5e-4, help=""
    "learning rate")
train_arg.add_argument(
...
train_arg.add_argument(
    "--log_base", type=str, default="../log_yfcc/", help=""
...
train_arg.add_argument(
    ...
    "validation interval")
train_arg.add_argument(
    "--save_intv", type=int, default=2000, help=""
    "summary interval")
train_arg.add_argument(
    "--log_intv", type=int, default=1000, help=""
    "log interval")
